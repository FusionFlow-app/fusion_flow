  ...
  render() {
    ...
    return html`
        ...
        if (this.onDelete) this.onDelete();
          ...
          title=${window.Translations && window.Translations["Remove Node"] || "Remove Node"}
        >×</div>
        ...
        if (this.onConfig) this.onConfig();
            ...
            title=${window.Translations && window.Translations["Configure Node"] || "Configure Node"}
        >
        ...
        <div 
          ...
          if (this.onErrorDetails) this.onErrorDetails();
            ...
            title=${window.Translations && window.Translations["View Error"] || "View Error"}
        >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
