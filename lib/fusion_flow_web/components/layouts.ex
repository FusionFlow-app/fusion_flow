    ...
    <div class="flex h-screen w-full bg-gray-50 dark:bg-slate-950 overflow-hidden">
      <aside class="w-20 lg:w-64 bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 flex flex-col items-center lg:items-start py-6 shadow-sm z-20 transition-all duration-300">
        <div class="px-0 lg:px-6 w-full flex justify-center lg:justify-start mb-8">
          <.link navigate={~p"/"} class="flex items-center gap-2 group transition-opacity hover:opacity-80">
            <div class="p-2 lg:p-1.5 w-10 h-10 lg:w-8 lg:h-8 rounded-lg bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center shadow-sm">
              <svg class="w-6 h-6 lg:w-5 lg:h-5 text-white shadow-sm" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <nav class="flex-1 w-full px-3 lg:px-4 space-y-2">
          <.link navigate={~p"/"} class="flex items-center justify-center lg:justify-start gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-gray-900 dark:hover:text-white transition-all group">
          ...
          <.link navigate={~p"/flows/new/ai"} class="flex items-center justify-center lg:justify-start gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-gray-900 dark:hover:text-white transition-all group">
            <svg class="w-6 h-6 lg:w-5 lg:h-5 text-gray-500 dark:text-gray-500 group-hover:text-purple-600 dark:group-hover:text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
