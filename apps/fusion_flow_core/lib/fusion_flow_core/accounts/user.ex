defmodule FusionFlowCore.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_username(changeset, _opts) do
    ...
    # |> unsafe_validate_unique(:username, FusionFlowCore.Repo)
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, FusionFlowCore.Repo)
  ...
  """
  def valid_password?(%FusionFlowCore.Accounts.User{hashed_password: hashed_password}, password)
