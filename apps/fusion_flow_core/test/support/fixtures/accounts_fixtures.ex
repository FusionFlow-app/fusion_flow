defmodule FusionFlowCore.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `FusionFlowCore.Accounts` context.
  """
  ...
  def override_token_authenticated_at(token, authenticated_at) when is_binary(token) do
    FusionFlowCore.Repo.update_all(
  ...
  def generate_user_magic_link_token(user) do
    ...
    FusionFlowCore.Repo.insert!(user_token)
  ...
  def invite_fixture(attrs \\ %{}) do
    ...
    %FusionFlowCore.Accounts.Invite{}
    |> FusionFlowCore.Accounts.Invite.changeset(base)
    |> FusionFlowCore.Repo.insert!()
  end
end
