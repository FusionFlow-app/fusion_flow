defmodule FusionFlowUI.UserLive.RegisterTest do
  ...
  describe "mount /users/register/:token" do
    ...
    test "submitting form creates user and marks invite used", %{conn: conn} do
      ...
      assert FusionFlowCore.Accounts.get_user_by_email(attrs.email)
      used_invite = FusionFlowCore.Repo.get!(FusionFlowCore.Accounts.Invite, invite.id)
      refute FusionFlowCore.Accounts.Invite.valid?(used_invite)
    end
  end
end
