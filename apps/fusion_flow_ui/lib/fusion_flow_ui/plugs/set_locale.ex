defmodule FusionFlowUI.Plugs.SetLocale do
  import Plug.Conn

  @supported_locales Gettext.known_locales(FusionFlowUI.Gettext)
  ...
  def call(conn, _options) do
    ...
    if locale do
      Gettext.put_locale(FusionFlowUI.Gettext, locale)
      ...
      conn
      |> assign(:locale, Gettext.get_locale(FusionFlowUI.Gettext))
    end
  end
  ...
  def on_mount(:default, params, session, socket) do
    ...
    locale = locale || Gettext.get_locale(FusionFlowUI.Gettext)
    Gettext.put_locale(FusionFlowUI.Gettext, locale)
