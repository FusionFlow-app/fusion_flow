defmodule FusionFlowUI.UserLive.Setup do
  ...
  def mount(_params, _session, socket) do
    if Accounts.has_system_admin?() do
      ...
      form =
        %FusionFlowCore.Accounts.User{}
        |> FusionFlowCore.Accounts.User.registration_changeset(%{})
        |> FusionFlowCore.Accounts.User.password_changeset(%{})
        |> to_form(as: "user")
